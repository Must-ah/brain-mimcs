...
# =============================================================================
# SpinalCord (typed ports + reject-on-wrong-type)
# =============================================================================

class SpinalCord:
    """SpinalCord plane façade.

    - Accepts only: AfferentSignal, EfferentCommand, ReflexRule/ReflexTrigger
    - Rejects everything else (emits RejectEvent to Reflect plane)
    - Publishes outcomes and optional reflex events
    """
    ...
    async def ingest(self, topic: str, msg: Any) -> None:
        """Typed entry point. Rejects wrong message classes."""
        ...
        # Direction rules can be enforced by topic prefix expectations as well.
        # NOTE: This is contract-level skeleton; real handlers would branch per mt.
        # Here we simply accept the message.
        return
